            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <!-- Modal -->
                        <form class="d-flex" action="carrinho.php" method="post">
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content ">
                                    ...
                                    <select  id="mySelect" size="4" name="select">
                                    </select>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Ambrosia Arte</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Nosso papel é colorir a sua vida!</p>
                </div>
            </div>
        </header>
        <!-- Section-->
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="text-center">
                                <a class="btn btn-outline-dark mt-auto" href="#"  onclick="addOption('Paleta de pintura - R$37,80')">Adicionar</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#" onclick="addOption('Conjunto de lápis de cor profissional - R$85,00')">Adicionar</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
